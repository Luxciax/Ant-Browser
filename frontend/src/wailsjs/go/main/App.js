...
export function AutomationDemoCreateProfile() {
  return window['go']['main']['App']['AutomationDemoCreateProfile']();
}

export function AutomationDemoCreateProfileWithOptions(arg1) {
  return window['go']['main']['App']['AutomationDemoCreateProfileWithOptions'](arg1);
}

export function AutomationDemoDeleteProfile(arg1) {
  return window['go']['main']['App']['AutomationDemoDeleteProfile'](arg1);
}

export function AutomationDemoHealthCheck() {
  return window['go']['main']['App']['AutomationDemoHealthCheck']();
}

export function AutomationDemoLaunchProfile(arg1) {
  return window['go']['main']['App']['AutomationDemoLaunchProfile'](arg1);
}

export function AutomationProbeSystemNode(arg1) {
  return window['go']['main']['App']['AutomationProbeSystemNode'](arg1);
}

export function AutomationRuntimeSelfCheck() {
  return window['go']['main']['App']['AutomationRuntimeSelfCheck']();
}

export function AutomationScriptDelete(arg1) {
  return window['go']['main']['App']['AutomationScriptDelete'](arg1);
}

export function AutomationScriptExport(arg1) {
...
export function AutomationScriptExportZip(arg1) {
  return window['go']['main']['App']['AutomationScriptExportZip'](arg1);
}

export function AutomationScriptGet(arg1) {
  return window['go']['main']['App']['AutomationScriptGet'](arg1);
}

export function AutomationScriptImportGit(arg1, arg2, arg3) {
  return window['go']['main']['App']['AutomationScriptImportGit'](arg1, arg2, arg3);
}

export function AutomationScriptImportLocalDirectory() {
  return window['go']['main']['App']['AutomationScriptImportLocalDirectory']();
}

export function AutomationScriptImportLocalFile() {
...
export function AutomationScriptList() {
  return window['go']['main']['App']['AutomationScriptList']();
}

export function AutomationScriptRefresh(arg1) {
  return window['go']['main']['App']['AutomationScriptRefresh'](arg1);
}

export function AutomationScriptRun(arg1) {
  return window['go']['main']['App']['AutomationScriptRun'](arg1);
}

export function AutomationScriptRunList(arg1) {
  return window['go']['main']['App']['AutomationScriptRunList'](arg1);
}

export function AutomationScriptRunWithOptions(arg1) {
  return window['go']['main']['App']['AutomationScriptRunWithOptions'](arg1);
}

export function AutomationScriptSave(arg1) {
...
export function SaveAutomationScriptPackageSettings(arg1) {
  return window['go']['main']['App']['SaveAutomationScriptPackageSettings'](arg1);
}
